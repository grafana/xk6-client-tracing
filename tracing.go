...
func traces() pdata.Traces {
	reader := bytes.NewBufferString(traceGore)
	r := &tempopb.Trace{}
      ...
      "instrumentationLibrarySpans":[
        {
          ...
          "spans":[
            {
              "traceId":"AAAAAAAAAABbdZuWJO/uiw==",
              "spanId":"W3WbliTv7os=",
              "name":"HTTP Client",
      ...
      "instrumentationLibrarySpans":[
        {
          ...
          "spans":[
            {
              "traceId":"AAAAAAAAAABFFdxqWiBZ9g==",
              "spanId":"RRXcalogWfY=",
              "name":"HTTP Client",
